#!/bin/bash
# medium batch32
DATASET=${1-reid-image-512-angular}   #sift-128-euclidean, deep-image-96-angular, fashion-mnist-784-euclidean, mnist-784-euclidean,glove-25-angular, glove-100-angular 
