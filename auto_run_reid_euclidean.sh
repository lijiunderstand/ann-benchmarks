...
python3 run.py --dataset reid-image-512-euclidean --runs 1 --batch --force --algorithm n2
python3 run.py --dataset reid-image-512-euclidean --runs 1 --batch --force --algorithm NGT-panng
python3 run.py --dataset reid-image-512-euclidean --runs 1 --batch --force --algorithm NGT-onng
python3 run.py --dataset reid-image-512-euclidean --runs 1 --batch --force --algorithm NGT-qg