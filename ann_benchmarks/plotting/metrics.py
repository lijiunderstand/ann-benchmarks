...
def best_search_time(queries, attrs):
...
all_metrics = {
    ...
    "best_search_time": {
        "description": "Best search time (s)",
        "function": lambda true_distances, run_distances, metrics, run_attrs: best_search_time(true_distances,
                                                                                               run_attrs),  # noqa
        "worst": float("inf")
    },    
    "distcomps": {
